        ...
        <Card className="py-4 cardAboutDept flex">
            ...
            <CardBody className="overflow-visible py-2 items-center">
                ...
                <div className="">
                    ...
                    <Spacer x={4} />
                    <p className="text-base font-small flex justify-center ">It is with great pleasure and enthusiasm that I welcome you to the Department of
                ...
                <br></br>
                    ...
                    <Spacer y={1} />
                    <p className="text-base font-bold ">Dr. Vivaksha Jariwala</p>
                    <Spacer y={1} />
                    <p className="text-base font-bold">Associate Professor and Head of the Department,</p>
                    <Spacer y={1} />
                    <p className="text-base font-bold">Department of Information Technology,</p>
                    <Spacer y={1} />
                    <p className="text-base font-bold">Sarvajanik College of Engineering and Technology,</p>

                    <Spacer y={1} />
                    <p className="text-base font-bold">Sarvajanik University</p>
